...
import 'favourite_names_model.dart';
export 'favourite_names_model.dart';

class FavouriteNamesWidget extends StatefulWidget {
  const FavouriteNamesWidget({Key? key}) : super(key: key);

  @override
  _FavouriteNamesWidgetState createState() => _FavouriteNamesWidgetState();
}

class _FavouriteNamesWidgetState extends State<FavouriteNamesWidget>
    with TickerProviderStateMixin {
  late FavouriteNamesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FavouriteNamesModel());
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            if (functions.quantityFuncBool(
                                    FFAppState().localNamesOfAllah.toList(),
                                    'learnt') ??
                                true)
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 5.0, 0.0, 15.0),
                                                child: Text(
                                                  'You haven\'t favourited any names',
